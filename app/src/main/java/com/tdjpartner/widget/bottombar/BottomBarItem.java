...
public class BottomBarItem extends LinearLayout {
    ...
    private void initAttrs(TypedArray ta) {
        ...
        titleTextSize = ta.getDimensionPixelSize(R.styleable.BottomBarItem_itemTextSize, GeneralUtils.sp2px(context, titleTextSize));

        titleNormalColor = ta.getColor(R.styleable.BottomBarItem_textColorNormal, GeneralUtils.getColor(context,R.color.bbl_999999));
        titleSelectedColor = ta.getColor(R.styleable.BottomBarItem_textColorSelected, GeneralUtils.getColor(context,R.color.bbl_ff0000));

        marginTop = ta.getDimensionPixelSize(R.styleable.BottomBarItem_itemMarginTop, GeneralUtils.dip2Px(context, marginTop));
        ...
        unreadTextSize = ta.getDimensionPixelSize(R.styleable.BottomBarItem_unreadTextSize, GeneralUtils.sp2px(context, unreadTextSize));
        unreadTextColor = ta.getColor(R.styleable.BottomBarItem_unreadTextColor, GeneralUtils.getColor(context,R.color.white));
        unreadTextBg = ta.getDrawable(R.styleable.BottomBarItem_unreadTextBg);

        msgTextSize = ta.getDimensionPixelSize(R.styleable.BottomBarItem_msgTextSize, GeneralUtils.sp2px(context, msgTextSize));
        msgTextColor = ta.getColor(R.styleable.BottomBarItem_msgTextColor, GeneralUtils.getColor(context,R.color.white));
    ...
    public void setNormalIcon(int resId){
        setNormalIcon(GeneralUtils.getDrawable(context,resId));
    }
    ...
    public void setSelectedIcon(int resId){
        setSelectedIcon(GeneralUtils.getDrawable(context,resId));
    }
    ...
    public static final class Builder {
        ...
        public Builder(Context context) {
            this.context = context;
            titleTextSize = GeneralUtils.sp2px(context,12);
            titleNormalColor = getColor(R.color.bbl_999999);
            titleSelectedColor = getColor(R.color.bbl_ff0000);
            unreadTextSize =  GeneralUtils.sp2px(context,10);
            msgTextSize =  GeneralUtils.sp2px(context,6);
        ...
        public Builder titleTextSize(int titleTextSize) {
            this.titleTextSize = GeneralUtils.sp2px(context,titleTextSize);
            return this;
        }
        ...
        public Builder unreadTextSize(int unreadTextSize) {
            this.unreadTextSize = GeneralUtils.sp2px(context,unreadTextSize);
            return this;
        }
        ...
        public Builder msgTextSize(int msgTextSize) {
            this.msgTextSize = GeneralUtils.sp2px(context,msgTextSize);
            return this;
        }
        ...
        public BottomBarItem create(int normalIconId, int selectedIconId, String text) {
            return create(GeneralUtils.getDrawable(context,normalIconId), GeneralUtils.getDrawable(context,selectedIconId),text);
        }
