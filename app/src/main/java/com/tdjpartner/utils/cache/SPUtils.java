...
public class SPUtils {
    ...
    private static class SPHolder{
        private static final SharedPreferences INSTANCE = PreferenceManager.getDefaultSharedPreferences(AppAplication.getAppContext());
    }
    ...
    private static SharedPreferences getSharedPreferences(@NonNull String name) {
        return AppAplication.getAppContext().getSharedPreferences(name, Context.MODE_PRIVATE);
    }
