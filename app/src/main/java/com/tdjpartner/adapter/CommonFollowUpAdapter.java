...
public class CommonFollowUpAdapter extends BaseQuickAdapter<DropOuting, BaseViewHolder> {
    public CommonFollowUpAdapter(int layoutResId, @Nullable List<DropOuting> data) {
