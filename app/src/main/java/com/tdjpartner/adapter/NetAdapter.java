 ...
 */
public class NetAdapter<T> extends ArrayAdapter<T> {
    ...
    public static final class Builder<M> {
        ...
        public NetAdapter<M> build(@NonNull Context context){
            return new NetAdapter<>(context, resource, initView, childIds, onClickListener);
        }
    }
    ...
    private NetAdapter(@NonNull Context context, int resource, InitView initView, List<Integer> childIds, View.OnClickListener onClickListener) {
