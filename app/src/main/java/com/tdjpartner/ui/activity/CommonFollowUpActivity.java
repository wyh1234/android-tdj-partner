...
public class CommonFollowUpActivity extends BaseActivity  implements SwipeRefreshLayout.OnRefreshListener, BaseQuickAdapter.OnItemChildClickListener {
    @BindView(R.id.rl_xd)
    ...
    public void onItemChildClick(BaseQuickAdapter baseQuickAdapter, View view, int i) {
        if (followUpPopuWindow!=null){
            ...
            followUpPopuWindow = new FollowUpPopuWindow(this,"");
