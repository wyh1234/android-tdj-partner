...
/**
 * Created by LFM on 2021/3/10.
 */
public class IronMonthActivity extends BaseActivity<TeamMemberPresenter> implements View.OnClickListener,
...
//    EditText search_text;
    ...
    @OnClick({R.id.tv_time, R.id.tv_month_sink})
    ...
    public void setTime(boolean hasDay) {
        pvTime = new TimePickerView.Builder(getContext(), new TimePickerView.OnTimeSelectListener() {
            ...
            public void onTimeSelect(Date date, View v) {
                tv_time.setText(GeneralUtils.getTime(date));
                getData();
            }
...
//        });*/
        ...
        ((TextView) other_include.findViewById(R.id.callNum)).setText("" + random.nextInt(1000));
        ((TextView) other_include.findViewById(R.id.firstOrderNum)).setText("" + random.nextInt(1000));
        ((TextView) other_include.findViewById(R.id.activeNum)).setText("" + random.nextInt(1000));
        ((TextView) other_include.findViewById(R.id.yesterdayActiveNum)).setText("" + random.nextInt(1000));
    ...
    protected int getLayoutId() {
        return R.layout.iron_month_list_layout;
    }
