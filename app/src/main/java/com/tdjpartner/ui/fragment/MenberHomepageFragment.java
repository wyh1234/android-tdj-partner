...
import com.tdjpartner.mvp.presenter.MenberHomepageFragmentPresenter;
...
//        endDate.set(2029, 11, 28);
    ...
    @Override
    protected MenberHomepageFragmentPresenter loadPresenter() {
        return new MenberHomepageFragmentPresenter();
    }
